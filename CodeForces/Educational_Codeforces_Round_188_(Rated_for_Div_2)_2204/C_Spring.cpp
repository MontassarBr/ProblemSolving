...
void solve() {
    ...
    f=k/c;
    l=k/lcm(lcm(a,b),c);
    q=l*2+((k/lcm(a,b))-l+(k/lcm(a,c))-l)*3+(d-((k/lcm(a,b))-l+(k/lcm(a,c))))*6;
    ll q1=l*2+((k/lcm(a,b))-l+(k/lcm(b,c))-l)*3+(e-((k/lcm(a,b))-l+(k/lcm(b,c))))*6;
    ll q2=l*2+((k/lcm(a,c))-l+(k/lcm(b,c))-l)*3+(f-((k/lcm(a,c))-l+(k/lcm(b,c))))*6;
